/*
  # Comprehensive Business Management Schema

  1. New Tables
    - `users` - Enhanced user profiles with roles and company info
    - `projects` - Complete project management system
    - `subscriptions` - Billing and subscription management
    - `usage_logs` - Track user activities and system usage
    - `admin_logs` - Administrative action audit trail
    - `contacts` - Advanced contact/feedback management
  ...
  3. Features
    - Project status tracking and assignment
