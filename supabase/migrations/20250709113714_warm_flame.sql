/*
  ...
  1. Updates
    - Ensures ai_qualification column exists
    - Updates existing records with new schema fields
    - Creates lead qualification update function
    
  2. New Fields
    - lead_summary: Concise summary of lead's project goals
    - qualification_status: HOT, WARM, or COLD
    - recommended_action: Next steps based on qualification
    - confidence_score: AI confidence level (1-10)
*/
...
SELECT update_ai_qualification_schema();
