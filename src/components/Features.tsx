        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className={`relative flex items-center justify-center w-20 h-20 bg-gradient-to-r ${feature.iconColor} rounded-xl mb-6 mx-auto transform transition-all duration-500 group-hover:scale-110 group-hover:rotate-6 animate-icon-float shadow-lg`}
                   style={{
                     boxShadow: `0 0 30px ${feature.glowColor === 'purple-500' ? '#a855f7' : feature.glowColor === 'yellow-500' ? '#eab308' : '#06b6d4'}40`
                   }}>
                {/* Icon Glow Effect */}
                <div className={`absolute inset-0 bg-gradient-to-r ${feature.iconColor} rounded-xl blur-md opacity-50 animate-pulse-slow`} />
