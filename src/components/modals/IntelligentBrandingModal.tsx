...
import { X, Palette, Eye, Type, TrendingUp, Smartphone, Monitor, Sun, Moon, BarChart3, Settings, Zap, Brain } from 'lucide-react';
  ...
  const brandingFeatures = [
    {
      ...
      color: 'purple',
      examples: [
        { icon: Monitor, label: 'Desktop Full Logo' },
        { icon: Smartphone, label: 'Mobile Icon' },
    ...
    },
    {
      ...
      examples: [
        ...
        { icon: Settings, label: 'Accessibility' },
    ...
    },
    {
      ...
      color: 'blue',
      examples: [
        { icon: Monitor, label: 'Device Adaptive' },
        { icon: Brain, label: 'AI Pairing' },
        { icon: Eye, label: 'Mood Response' },
        { icon: Zap, label: 'Auto-optimize' }
      ]
    },
    {
      icon: TrendingUp,
      ...
      color: 'emerald',
      examples: [
        { icon: BarChart3, label: 'Evolution Analytics' },
        { icon: Eye, label: 'Sentiment Tracking' },
        { icon: Settings, label: 'Consistency Monitor' },
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {brandingFeatures.map((feature, index) => (
                ...
                >
                  ...
                  {/* Examples Grid */}
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-blue-300 mb-3">Examples:</h4>
                    <div className="grid grid-cols-2 gap-3">
                      {feature.examples.map((example, exampleIndex) => (
                        <div key={exampleIndex} className="flex items-center space-x-2 bg-slate-800/50 rounded-lg p-3">
                          <example.icon className={`text-${feature.color}-400`} size={16} />
                          <span className="text-slate-300 text-xs">{example.label}</span>
                        </div>
                      ))}
                    </div>
                  </div>
